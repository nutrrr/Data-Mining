...
export function crossover(parent1, parent2) {
    if (typeof parent1 === 'undefined' && typeof parent1 === 'undefined') {return}
    if (typeof parent1 === 'undefined'){ return [, parent2] }
    if (typeof parent2 === 'undefined'){ return [parent1, ] }
...
export function geneticAlgorithm(userItemTyep, targetFitness, mutationRate, listItem, numPopulation, selectedState, maxGeneration){
    ...
    do{
        ...
        let numChrKeep = Math.floor(numPopulation/2); // จำนวนที่เก็บ chromosome ไว้ในรอบถัดไป
        let newPopulation = [];
